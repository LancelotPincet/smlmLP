...
# %% Function
@block()
def spatial_localmean(channels, localmean_radius=7, channel_pixel=1., pad=0, bkgds=None, cuda=False, parallel=False) :
    '''
    ...
    for i in range(len(channels)) :
        ...
        new_bkgd = img_gaussianfilter(channel, sigma=localmean_sigma, pixel=pixel[i], out=bkgd, cuda=cuda, parallel=parallel, stacks=True)
