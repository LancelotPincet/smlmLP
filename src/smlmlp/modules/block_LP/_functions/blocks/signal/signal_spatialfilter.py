...
# %% Function
@block()
def signal_spatialfilter(channels, /, spatial_kernel, signals=None, bkgds=None, *, pad=0, cuda=False, parallel=False) :
    '''
    ...
    for i in range(len(channels)) :
        ...
        new_signal = img_correlate(channel, kernel, out=signal, cuda=cuda, parallel=parallel, stacks=True)
