...
class frames(DataFrame) :
    ...
    @column(headers=['frame', 'frames'], dtype=np.uint32, fill=0, save=True, agg='min', index="points")
    def fr(self) :
    ...
    @column(headers=['nodrift [nm]'], dtype=np.float32, fill=0, save=False, agg='mean')
    def nodrift(self) :
        """Return a zero drift vector."""
        return np.zeros(self.locs.nframes, dtype=np.float32)

    @column(headers=['drift x [nm]'], dtype=np.float32, fill=np.nan, save=False, agg='mean')
    def dx(self) :
    ...
    @column(headers=['drift y [nm]'], dtype=np.float32, fill=np.nan, save=False, agg='mean')
    def dy(self) :
    ...
    @column(headers=['drift z [nm]'], dtype=np.float32, fill=np.nan, save=True, agg='mean')
    def dz(self) :
    ...
    @column(headers=['drift x crosscorr [nm]'], dtype=np.float32, fill=np.nan, save=True, agg='mean')
    ...
    @column(headers=['drift y crosscorr [nm]'], dtype=np.float32, fill=np.nan, save=True, agg='mean')
    ...
    @column(headers=['drift z crosscorr [nm]'], dtype=np.float32, fill=np.nan, save=True, agg='mean')
    ...
    @column(headers=['drift x comet [nm]'], dtype=np.float32, fill=np.nan, save=True, agg='mean')
    def dx_comet(self) :
    ...
    @column(headers=['drift y comet [nm]'], dtype=np.float32, fill=np.nan, save=True, agg='mean')
    def dy_comet(self) :
    ...
    @column(headers=['drift z comet [nm]'], dtype=np.float32, fill=np.nan, save=True, agg='mean')
    def dz_comet(self) :
    ...
    @column(headers=['drift x aim [nm]'], dtype=np.float32, fill=np.nan, save=True, agg='mean')
    def dx_aim(self) :
    ...
    @column(headers=['drift y aim [nm]'], dtype=np.float32, fill=np.nan, save=True, agg='mean')
    def dy_aim(self) :
    ...
    @column(headers=['drift z aim [nm]'], dtype=np.float32, fill=np.nan, save=True, agg='mean')
    def dz_aim(self) :
    ...
    @column(headers=['drift x meanshift [nm]'], dtype=np.float32, fill=np.nan, save=True, agg='mean')
    ...
    @column(headers=['drift y meanshift [nm]'], dtype=np.float32, fill=np.nan, save=True, agg='mean')
    ...
    @column(headers=['drift z meanshift [nm]'], dtype=np.float32, fill=np.nan, save=True, agg='mean')
    ...
    @column(headers=['time [ms]'], dtype=np.float32, fill=np.nan, save=False, agg='mean')
    def time(self) :
