...
class channels(DataFrame) :
    ...
    @column(headers=['channel'], dtype=np.uint8, fill=0, save=False, agg='min', index="detections")
    def ch(self) :
    ...
    @column(headers=['x pixel [nm]'], dtype=np.float32, fill=np.nan, save=False, agg='mean')
    def x_pixel(self) :
    ...
    @column(headers=['y pixel [nm]'], dtype=np.float32, fill=np.nan, save=False, agg='mean')
    def y_pixel(self) :
    ...
    @column(headers=['x shape [pix]'], dtype=np.uint8, fill=0, save=False, agg='mean')
    def x_shape(self) :
    ...
    @column(headers=['y shape [pix]'], dtype=np.uint8, fill=0, save=False, agg='mean')
    def y_shape(self) :
    ...
    @column(headers=['qe'], dtype=np.float32, fill=np.nan, save=False, agg='mean')
    def qe(self) :
    ...
    @column(headers=['camera index'], dtype=np.float32, fill=0, save=False, agg='mean')
    def cam(self) :
    ...
    @column(headers=['x flip'], dtype=np.bool_, fill=0, save=False, agg='max')
    def x_flip(self) :
    ...
    @column(headers=['y flip'], dtype=np.bool_, fill=0, save=False, agg='max')
    def y_flip(self) :
    ...
    @column(headers=['psf x sigma [nm]'], dtype=np.float32, fill=np.nan, save=False, agg='mean')
    ...
    @column(headers=['psf y sigma [nm]'], dtype=np.float32, fill=np.nan, save=False, agg='mean')
    ...
    @column(headers=['psf theta [deg]'], dtype=np.float32, fill=np.nan, save=False, agg='mean')
    def psf_theta(self) :
    ...
    @column(headers=['registration x shift [nm]'], dtype=np.float32, fill=np.nan, save=False, agg='mean')
    def x_shift(self) :
    ...
    @column(headers=['registration y shift [nm]'], dtype=np.float32, fill=np.nan, save=False, agg='mean')
    def y_shift(self) :
    ...
    @column(headers=['registration rotation [deg]'], dtype=np.float32, fill=np.nan, save=False, agg='mean')
    def rotation(self) :
    ...
    @column(headers=['registration x shear'], dtype=np.float32, fill=np.nan, save=False, agg='mean')
    def x_shear(self) :
    ...
    @column(headers=['registration y shear'], dtype=np.float32, fill=np.nan, save=False, agg='mean')
    def y_shear(self) :
    ...
    @column(headers=['x cropshape [pix]'], dtype=np.float32, fill=0, save=False, agg='mean')
    ...
    @column(headers=['y cropshape [pix]'], dtype=np.float32, fill=0, save=False, agg='mean')
    ...
    @column(headers=['x cropsize [nm]'], dtype=np.float32, fill=np.nan, save=False, agg='mean')
    def x_cropsize(self) :
        """Return x crop size for each channel."""
        return self.x_cropshape * self.x_pixel

    @column(headers=['y cropsize [nm]'], dtype=np.float32, fill=np.nan, save=False, agg='mean')
    def y_cropsize(self) :
